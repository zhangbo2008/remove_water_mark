...
class WatermarkRemover(object):
    ...
    def remove_watermark_raw(self, img, watermark_template_gray_img, watermark_template_mask_img,shuru=None):
        """
        去除图片中的水印
        :param img: 待去除水印图片位图
    ...
    def remove_watermark(self, filename, output_filename=None,shuru=None):
        """
        去除图片中的水印
        ...
        dst = self.remove_watermark_raw(img,
                                        ...
                                        self.watermark_template_mask_img,shuru
                                        )
